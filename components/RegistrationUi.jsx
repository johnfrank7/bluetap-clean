...
const styles = StyleSheet.create({
  ...
  connector: { position: 'absolute', height: 2, backgroundColor: '#D9E7F1', top: 14, right: '50%', left: '-50%' },
  connectorComplete: { backgroundColor: '#65AEE7' },
  stepButton: { width: '100%', minHeight: 50, alignItems: 'center', zIndex: 1 },
  stepCircle: { width: 30, height: 30, borderRadius: 15, backgroundColor: '#E8F1F8', borderWidth: 1, borderColor: '#D5E4EF', alignItems: 'center', justifyContent: 'center' },
  ...
  backButton: { minHeight: 50, minWidth: 92, paddingHorizontal: 20, borderWidth: 1, borderColor: '#B9CEDD', borderRadius: 11, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFF' },
  ...
  primaryDisabled: { backgroundColor: '#DCEAF4' },
  backText: { color: '#3D607B', fontSize: 15, fontWeight: '700', textAlign: 'center' },
  primaryText: { color: '#FFF', fontSize: 15, fontWeight: '800', textAlign: 'center' },
  primaryTextDisabled: { color: '#6F8CA2' },
});
