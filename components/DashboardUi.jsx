...
export function SectionCard({ children, style }) { const { colors } = useAdminTheme(); return <View style={[shared.card, { backgroundColor:colors.surface, borderColor:colors.border, shadowColor:colors.textPrimary }, style]}>{children}</View>; }
