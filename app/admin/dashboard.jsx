...
const REGISTERED_DISTRIBUTORS = [
  { name: 'Gabrielle Flores', phone: '09123456789', email: 'gabflores@gmail.com' },
  { name: 'Rose Baricuatro', phone: '09123456788', email: 'rosebaricuatro@gmail.com' },
  { name: 'Junard Remeticado', phone: '09123456787', email: 'junardreme@gmail.com' },
  { name: 'Luo Hiyan', phone: '09123456778', email: 'luohiyan@gmail.com' },
];
        ...
        <View style={styles.main}>
          ...
          <ScrollView contentContainerStyle={styles.cardScroll} showsVerticalScrollIndicator={false}>
            <View style={styles.card}>
              ...
              {/* Table rows */}
              {REGISTERED_DISTRIBUTORS.map((d, idx) => (
                <View
                  key={d.email}
                ...
                >
                  ...
                  <Text style={[styles.cell, styles.cellEmail]}>{d.email}</Text>
                </View>
              ))}
            </View>
          </ScrollView>
